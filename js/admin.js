...
function render(){
 $('#pageTitle').textContent=({site:'Homepage',projects:'Projects',testimonials:'Testimonials',footer:'Footer',about:'About',services:'Services',navigation:'Navigation',socials:'Social Links',theme:'Appearance',advanced:'Advanced JSON',overview:'Overview'})[tab]||tab;
 const p=$('#panel');
